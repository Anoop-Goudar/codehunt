...
echo "</tr>";
    ...
    <section class="register">
       ...
       // $qid=$_GET["qid"];
        mysql_connect("localhost", "","") or die("No connection");
mysql_select_db("test") or die ("DATABASE not availabel");
$sql1="select answer,datee,aid,timee,author from answers where qid =$qid";
...
echo"<td><input type='image' name='like' src='like.png'/></td>";
echo"<td><input type='image' name='dislike' src='dlike.png'/></td>";
